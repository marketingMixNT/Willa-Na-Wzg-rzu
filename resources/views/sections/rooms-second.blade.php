		...
		<div class='flex flex-col lg:flex-row justify-between  h-full gap-8 md:gap-12 lg:gap-16 2xl:gap-32 '>
			...
			<div class='flex flex-col justify-between gap-8 md:gap-16 lg:gap-12 w-full lg:w-[45%] lg:order-1'>
				<div class='space-y-12'>
					<h2 class='heading'>Doskonała Lokalizacja</h2>
					<p class='text'>
				...
				<div class=''>
					<ul class='space-y-5'>
						<li class='flex items-center gap-6'>
							...
							<span class='uppercase font-light text-sm 2xl:font-base'>Bliskość szlaków turystycznych</span>
						</li>
						<li class='flex items-center gap-6'>
							<img src='/icons/mountains.svg' alt='' class=' w-8 2xl:w-12' />
							<span class='uppercase font-light text-sm 2xl:font-base'>Widok na góry</span>
						</li>
						<li class='flex items-center gap-6'>
							<img src='/icons/internet.svg' alt='' class=' w-8 2xl:w-12' />
							<span class='uppercase font-light text-sm 2xl:font-base'>Szybkie WI-FI</span>
						</li>
						<li class='flex items-center gap-6'>
							<img src='/icons/sun.svg' alt='' class=' w-8 2xl:w-12' />
							<span class='uppercase font-light text-sm 2xl:font-base'>Komfortowe warunki</span>
						</li>
					</ul>
				</div>
