<x-layout>
    ...
    @section('description', 'Zapoznaj się z naszą polityką prywatności.')
  


   
        <main class="max-w-screen-xl mx-4 sm:mx-12 lg:mx-6 xl:mx-auto space-y-12 py-20">

            <h2 class="text-3xl pb-6">Polityka prywatności opisuje zasady przetwarzania przez nas informacji na Twój temat, w
                tym danych osobowych oraz ciasteczek, czyli tzw. cookies.</h2>

            <div class="space-y-5">


                <h3 class="text-4xl">Informacje ogólne</h3>
                <p>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: <a
                        href="https://willanawzgorzu.com.pl/"> willanawzgorzu.com.pl/</a></p>
                <p>Operatorem serwisu oraz Administratorem danych osobowych jest: <strong>Żywczańskie 22c
                    34-500 Zakopane</strong></p>
                <p>Adres kontaktowy poczty elektronicznej operatora: <a
                        href="kontakt@willanawzgorzu.pl">kontakt@willanawzgorzu.pl</a></p>
            ...
            <div class="space-y-5">
                ...
                <h3 class="text-4xl">Wybrane metody ochrony danych stosowane przez Operatora</h3>
            ...
            <div class="space-y-5">
                ...
                <h3 class="text-4xl">Hosting</h3>
                <p>Serwis jest hostowany (technicznie utrzymywany) na serwerach operatora: hostido.pl</p>
            ...
            <div class="space-y-5">
                <h3 class="text-4xl">Twoje prawa i dodatkowe informacje o sposobie wykorzystania danych</h3>
...
<p>Dane osobowe nie są przekazywane od krajów trzecich w rozumieniu przepisów o ochronie danych osobowych. Oznacza to, że nie przesyłamy ich poza teren Unii Europejskiej.</p>
            ...
            <div class="space-y-5">
                <h3 class="text-4xl">Informacje w formularzach</h3>
...
<p>Dane podane w formularzu są przetwarzane w celu wynikającym z funkcji konkretnego formularza, np. w celu dokonania procesu obsługi zgłoszenia serwisowego lub kontaktu handlowego, rejestracji usług itp. Każdorazowo kontekst i opis formularza w czytelny sposób informuje, do czego on służy.</p>
            ...
            <div class="space-y-5">
                ...
                <h3 class="text-4xl">Logi Administratora</h3>
<p>Informacje o zachowaniu użytkowników w serwisie mogą podlegać logowaniu. Dane te są wykorzystywane w celu administrowania serwisem.</p>
            ...
            <div class="space-y-5">
                <h3 class="text-4xl">Istotne techniki marketingowe</h3>
...
<p>Operator stosuje korzysta z piksela Facebooka. Ta technologia powoduje, że serwis Facebook (Facebook Inc. z siedzibą w USA) wie, że dana osoba w nim zarejestrowana korzysta z Serwisu. Bazuje w tym wypadku na danych, wobec których sam jest administratorem, Operator nie przekazuje od siebie żadnych dodatkowych danych osobowych serwisowi Facebook. Usługa bazuje na wykorzystaniu ciasteczek w urządzeniu końcowym użytkownika.</p>
            ...
            <div class="space-y-5">
                <h3 class="text-4xl">Informacja o plikach cookies</h3>
...
<p>Pliki cookies zamieszczane w urządzeniu końcowym Użytkownika Serwisu wykorzystywane mogą być również przez współpracujące z operatorem Serwisu podmioty, w szczególności dotyczy to firm: Google (Google Inc. z siedzibą w USA), Facebook (Facebook Inc. z siedzibą w USA), Twitter (Twitter Inc. z siedzibą w USA).</p>
            ...
            <div class="space-y-5">
                <h3 class="text-4xl">Zarządzanie plikami cookies – jak w praktyce wyrażać i cofać zgodę?</h3>
...
<p>W celu zarządzania ustawieniami cookies wybierz z listy poniżej przeglądarkę internetową, której używasz i postępuj zgodnie z instrukcjami:</p>
<ul>
  <li>Edge</li>
